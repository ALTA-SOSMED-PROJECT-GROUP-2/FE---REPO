  ...
  return (
    <div className='h-screen bg-sage4 flex flex-col justify-center items-center'>
      <form className='flex flex-col w-full md:w-1/3 bg-white rounded-md p-8'>
        ...
        <Button className='mx-4 sm:mx-8 mt-6 sm:mt-8 bg-sage3 hover:bg-sage2'>Login</Button>
        <p className='mt-2 sm:mt-3 text-center text-sm'>Don't have an account? <span className='text-sage1'>Sign Up</span></p>
      </form>
    </div>
  );
};
